from api import views  # ✅ Correct - imports views from your current app
...
from auth.views import CustomAdminPasswordResetView
...
urlpatterns = [
   ...
   path(
        ...
        CustomAdminPasswordResetView.as_view(
