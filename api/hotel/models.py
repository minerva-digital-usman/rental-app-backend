...
class Hotel(models.Model):
    ...
    latitude = models.DecimalField(max_digits=9, decimal_places=10, null=True, blank=True)
    longitude = models.DecimalField(max_digits=9, decimal_places=10, null=True, blank=True)
